document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        pt: {
            ...
            pack_title: "Planos e Pacotes",
            pack_badge: "Mais Popular",
            pack_btn: "Falar com Consultor",
            pack1_name: "Essential",
            pack1_desc: "Ideal para iniciar a jornada de dados com análises fundamentais.",
            pack1_feat1: "Análise básica de dados",
            pack1_feat2: "Relatório gerencial mensal",
            pack1_feat3: "Suporte por email",
            pack2_name: "Plus",
            pack2_desc: "Para empresas em crescimento que precisam de agilidade.",
            pack2_feat1: "Dashboards interativos",
            pack2_feat2: "Atualização semanal de dados",
            pack2_feat3: "Suporte prioritário",
            pack3_name: "Premium",
            pack3_desc: "Solução completa e avançada para operações complexas.",
            pack3_feat1: "BI em tempo real",
            pack3_feat2: "Automação de processos",
            pack3_feat3: "Consultor dedicado",
            pack4_name: "Exclusive",
            pack4_desc: "Totalmente adaptado à sua necessidade e regras de negócio.",
            pack4_feat1: "Escopo 100% flexível",
            pack4_feat2: "Desenvolvimento sob medida",
            pack4_feat3: "SLA personalizado",
        ...
        en: {
            ...
            pack_title: "Plans & Packages",
            pack_badge: "Most Popular",
            pack_btn: "Talk to an Expert",
            pack1_name: "Essential",
            pack1_desc: "Ideal to start your data journey with fundamental analysis.",
            pack1_feat1: "Basic data analysis",
            pack1_feat2: "Monthly management report",
            pack1_feat3: "Email support",
            pack2_name: "Plus",
            pack2_desc: "For growing companies that need agility and insights.",
            pack2_feat1: "Interactive dashboards",
            pack2_feat2: "Weekly data updates",
            pack2_feat3: "Priority support",
            pack3_name: "Premium",
            pack3_desc: "Complete and advanced solution for complex operations.",
            pack3_feat1: "Real-time BI",
            pack3_feat2: "Process automation",
            pack3_feat3: "Dedicated consultant",
            pack4_name: "Exclusive",
            pack4_desc: "Fully tailored to your needs and business rules.",
            pack4_feat1: "100% flexible scope",
            pack4_feat2: "Custom development",
            pack4_feat3: "Custom SLA",
